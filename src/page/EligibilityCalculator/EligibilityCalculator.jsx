                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="p-4 md:p-6 bg-linear-to-br from-slate-50 via-white to-indigo-50">
                                ...
                                <div className="mt-8">
                                    <button
                                        ...
                                        className="w-full bg-indigo-800 text-white p-3 rounded-lg font-semibold hover:bg-indigo-600 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed shadow-lg transition-all duration-300 transform cursor-pointer"
                                    >
                                        {isSubmitting ? (
                        ...
                        {result ? (
                            <div className="space-y-6">
                                ...
                                <div className="text-center">
                                    <button
                                        onClick={handleReset}
                                        className="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all duration-300 focus:outline-none shadow-md cursor-pointer"
                                    >
